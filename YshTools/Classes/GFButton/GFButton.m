...
- (void)didInitialize {
    ...
    self.imagePosition = GFUIButtonImagePositionLeft;
}
...
- (CGSize)sizeThatFits:(CGSize)size {
    ...
    switch (self.imagePosition) {
        case GFUIButtonImagePositionTop:
        case GFUIButtonImagePositionBottom: {
        ...
        case GFUIButtonImagePositionLeft:
        case GFUIButtonImagePositionRight: {
...
- (void)layoutSubviews {
    ...
    if (self.imagePosition == GFUIButtonImagePositionTop || self.imagePosition == GFUIButtonImagePositionBottom) {
        ...
        if (self.imagePosition == GFUIButtonImagePositionTop) {
    ...
    } else if (self.imagePosition == GFUIButtonImagePositionLeft || self.imagePosition == GFUIButtonImagePositionRight) {
        ...
        if (self.imagePosition == GFUIButtonImagePositionLeft) {
            switch (self.contentHorizontalAlignment) {
                case UIControlContentHorizontalAlignmentLeft:
                    imageFrame = isImageViewShowing ? CGRectSetX(imageFrame, contentEdgeInsets.left + self.imageEdgeInsets.left) : imageFrame;
...
//    return self.spacingBetweenImageAndTitle;
//}

- (void)setImagePosition:(GFUIButtonImagePosition)imagePosition {
    _imagePosition = imagePosition;
    
//    self.imagePosition = imagePosition;
    
//    NSString * s = [NSString stringWithFormat:@"%ld",(long)imagePosition];
//
//    objc_setAssociatedObject(self, @selector(imagePosition), s, OBJC_ASSOCIATION_COPY_NONATOMIC);



    
//    objc_setAssociatedObject(self, @selector(imagePosition), imagePosition, OBJC_ASSOCIATION_COPY_NONATOMIC);
    
    [self setNeedsLayout];
}

//- (QMUIButtonImagePosition)imagePosition
//{
////    return [objc_getAssociatedObject(self, &nameKey) integerValue];
//
//
//    return [objc_getAssociatedObject(self, @selector(imagePosition)) integerValue];
//
